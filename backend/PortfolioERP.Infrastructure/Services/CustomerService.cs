        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!string.IsNullOrWhiteSpace(parameters.Search))
        {
            ...
            query = query.Where(customer =>
                EF.Functions.Like(customer.CustomerCode, $"%{search}%") ||
                EF.Functions.Like(customer.CompanyName, $"%{search}%") ||
                EF.Functions.Like(customer.Email, $"%{search}%") ||
                (
                    customer.FirstName != null &&
                    EF.Functions.Like(customer.FirstName, $"%{search}%")
                ) ||
                (
                ...
                (
                    ...
                    EF.Functions.Like(customer.TaxCode, $"%{search}%")
                ) ||
                (
                    customer.VatNumber != null &&
                    EF.Functions.Like(customer.VatNumber, $"%{search}%")
                ));
        }
        ...
        if (!string.IsNullOrWhiteSpace(parameters.City))
        {
            ...
            query = query.Where(customer =>
                customer.City != null &&
                EF.Functions.Like(customer.City, city));
        }
        ...
        if (!string.IsNullOrWhiteSpace(parameters.Country))
        {
            ...
            query = query.Where(customer =>
                EF.Functions.Like(customer.Country, country));
        }
